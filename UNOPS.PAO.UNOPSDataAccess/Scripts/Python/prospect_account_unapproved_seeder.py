...
def generate_prospect_account_seeder():
    ...
    csv_path = os.path.join(script_dir, '..', 'CSV', 'Prospect_Accounts_Unapproved_20251008 - Sheet1.csv')
    output_path = os.path.join(script_dir, '..', '..', 'Seed', 'Seeders', 'ProspectAccountsSeeder.cs')
