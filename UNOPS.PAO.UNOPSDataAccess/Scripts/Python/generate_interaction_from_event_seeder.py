...
- CSV input: UNOPS.PAO.UNOPSDataAccess/Scripts/CSV/Events_20251009 - Sheet2.csv
...
def main():
    ...
    csv_file = os.path.join(script_dir, "..", "CSV", "Events_20251009 - Sheet2.csv")
    output_file = os.path.join(script_dir, "..", "..", "Seed", "Seeders", "InteractionFromEventSeeder.cs")
