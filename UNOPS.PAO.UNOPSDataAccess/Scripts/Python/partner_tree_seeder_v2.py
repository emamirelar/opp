...
- CSV input: UNOPS.PAO.UNOPSDataAccess/Scripts/CSV/Partner tree export 02-Oct-2025 - Sheet1.csv
...
def main():
    ...
    # Define file paths
    csv_file = os.path.join(script_dir, '../CSV/Partner tree export 02-Oct-2025 - Sheet1.csv')
    output_file = os.path.join(script_dir, '../../Seed/Seeders/PartnerTreeSeeder_v2.cs')
