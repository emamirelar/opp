...
public static class OutputSeeder
{
    ...
    private static List<Output> GetOutputsToSeed()
    {
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Project management-related services",
            Level1 = @"Programme or Portfolio Management Office",
...
Programme and Portfolio exclusive. ",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Project management-related services",
            Level1 = @"Technical advisory services - project management",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Project management-related services",
            Level2 = @"Technical assistance services - project management",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Project management-related services",
            Level3 = @"Training services - project management",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Project management-related services",
            Level3 = @"Capacity building - project management",
        ...
        outputs.Add(new Output
        {
            ...
            DefinitionLevel1 = @"Infrastructure-related works implemented on a physical asset 
(Design / Construction / Rehabilitation / Installations / Others).",
            Level2 = @"Building",
            ServiceLine = @"Infrastructure",
            GrantSupportImplementingModality = true,
            GrantSupportComponent = true,
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"School (primary / secondary)",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Teacher training center",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Vocational training center",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Housing and accommodation facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Fishery",
            DefinitionLevel4 = @"A facility used in the capture, processing, storge, and distribution of fish and other aquatic organisms.",
            ServiceLine = @"Infrastructure",
            GrantSupportImplementingModality = true,
            GrantSupportComponent = true,
            ProcurementComponent = true,
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Institutional facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Correctional facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Prisons / detention facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Custom / border control facility",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Industrial and logistical facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Cultural and recreational facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Non-lethal support facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Military training facility",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Police training facility",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"FIBUA (fighting in built-up areas) units",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Ammunition and weapons storage facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Cancer treatment center / oncology center",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level2 = @"Sitework and ancillary facilities
",
...
",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Construction and civil engineering laboratories",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Healthcare and medical laboratories",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Manufacturing and industrial laboratories",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Environmental laboratories",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Food and agricultural laboratories",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level2 = @"Agricultural facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Agricultural administrative building",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Aviation infrastructure",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"HLS (helicopter landing site)",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Aviation intelligent system",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Terminal services and amenities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Horizontal infrastructure",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Road safety barrier / structure",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Water supply treatment and distribution facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Aquifer management system",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Water supply pipeline / network",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Water storage facilities",
...
",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level2 = @"Wastewater and sanitation",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Wastewater treatment facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Wastewater treatment plant",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Packaged wastewater treatment plant",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Soak pit / infiltration trench",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Trench drain / channel drain",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Side drain / roadside drain",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Waste collection and separation facility",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Waste disposal facility",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Waste processing facility",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Hazardous waste management",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Hazardous waste facility",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Leachate and gas emission system",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Coastal protection / defensive works",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Flood control and drainage facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Sedimentation tank / settling tank / clarifier",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Riverbank stabilization system",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Surface and sub-surface drainage system (flood control, drainage channel)",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level2 = @"Energy / power facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Power generation facilities (renewable)",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Hydroelectric power plant",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Waste-to-energy facility",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Power generation facilities / power plant",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Power transmission facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Mast for energy transmission",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Power distribution facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Power distribution center / distribution substation",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"LV / MV distribution network",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Oil and gas transmission facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Oil and gas storage facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"LNG (liquified natural gas) reservoir",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Diesel generator support structure",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Bulk fuel storage facility",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Internet and telephone facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level4 = @"Mast for ICT infrastructure",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"TV and radio facilities",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level1 = @"Infrastructure Technical Services",
...
Beyond planning and design, this service line extends to the execution phase through construction supervision. This ensures that physical works are monitored and controlled on-site to guarantee strict compliance with design specifications, quality standards, schedules, and HSSE requirements, ultimately delivering safe and functional infrastructure assets.",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level2 = @"Construction Supervision",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level1 = @"Technical advisory services - infrastructure",
            DefinitionLevel1 = @"The provision of high-level strategic expertise to expand the capacity of partners, specifically targeting their people and systems. This service involves offering expert support, advice, recommendations, or strategic guidance to define the path forward on the conceptual and design phase, diagnosing complex challenges and determining the optimal course of action without UNOPS direct execution.",
            ServiceLine = @"Infrastructure",
            GrantSupportImplementingModality = true,
            GrantSupportComponent = true,
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level2 = @"Technical assistance services - infrastructure",
            DefinitionLevel2 = @"The provision of specialized operational expertise to guide, review, and support the partner’s implementation efforts. This service provides technical guidance for complex processes without UNOPS taking over direct execution.",
            ServiceLine = @"Infrastructure",
            GrantSupportImplementingModality = true,
            GrantSupportComponent = true,
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Training services - infrastructure",
            DefinitionLevel3 = @"A targeted educational intervention designed strictly to enhance the knowledge, skills, and competencies of individual personnel. It is delivered through finite learning events, such as workshops, seminars, or certification courses, aimed at closing immediate skill gaps to empower individuals to perform their roles effectively.",
            ServiceLine = @"Infrastructure",
            GrantSupportImplementingModality = true,
            GrantSupportComponent = true,
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Infrastructure-related services",
            Level3 = @"Capacity building - infrastructure",
            DefinitionLevel3 = @"A broad, systemic intervention designed to strengthen institutional infrastructure and the enabling environment. It focuses on advising on and developing organizational assets, such as governance structures, operational systems, and frameworks, that are sustained nationally or institutionally.",
            ServiceLine = @"Infrastructure",
            GrantSupportImplementingModality = true,
            GrantSupportComponent = true,
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Procurement-related services",
            Level2 = @"Services - explosive threat management",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Procurement-related services",
            Level2 = @"Services - management consultancy",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Procurement-related services",
            Level2 = @"Services - safety and security",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Procurement-related services",
            Level1 = @"Technical advisory services - procurement",
            DefinitionLevel1 = @"The provision of high-level strategic expertise to expand the capacity of partners, specifically targeting their people and systems. This service involves offering expert support, advice, recommendations, or strategic guidance to define the path forward on the conceptual and design phase, diagnosing complex challenges and determining the optimal course of action without UNOPS direct execution.",
            ServiceLine = @"Procurement",
            GrantSupportImplementingModality = true,
            GrantSupportComponent = true,
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Procurement-related services",
            Level2 = @"Technical assistance services - procurement",
            DefinitionLevel2 = @"The provision of specialized operational expertise to guide, review, and support the partner’s implementation efforts. This service provides technical guidance for complex processes without UNOPS taking over direct execution.",
            ServiceLine = @"Procurement",
            GrantSupportImplementingModality = true,
            GrantSupportComponent = true,
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Procurement-related services",
            Level3 = @"Training services - procurement",
            DefinitionLevel3 = @"A targeted educational intervention designed strictly to enhance the knowledge, skills, and competencies of individual personnel. It is delivered through finite learning events, such as workshops, seminars, or certification courses, aimed at closing immediate skill gaps to empower individuals to perform their roles effectively.",
            ServiceLine = @"Procurement",
            GrantSupportImplementingModality = true,
            GrantSupportComponent = true,
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Procurement-related services",
            Level3 = @"Capacity building - procurement",
            DefinitionLevel3 = @"A broad, systemic intervention designed to strengthen institutional infrastructure and the enabling environment. It focuses on advising on and developing organizational assets, such as governance structures, operational systems, and frameworks, that are sustained nationally or institutionally.",
            ServiceLine = @"Procurement",
            GrantSupportImplementingModality = true,
            GrantSupportComponent = true,
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Financial management-related services",
            Level1 = @"Financial transfers-related services",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Financial management-related services",
            Level3 = @"Grant support (under competitive selection)",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Financial management-related services",
            Level3 = @"Grant support (under preselection)",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Financial management-related services",
            Level3 = @"Grant support (under tailored selection - ad hoc)",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Financial management-related services",
            Level3 = @"Grant support (under exceptions to the competitive process - ad hoc)",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Financial management-related services",
            Level2 = @"Cash and voucher assistance",
...
This differs from 'cash for training,' where payment is conditional on attending training, not performing work.",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Financial management-related services",
            Level4 = @"Cash for work (under preselection)",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Financial management-related services",
            Level1 = @"Technical advisory services - financial management",
            DefinitionLevel1 = @"The provision of high-level strategic expertise to expand the capacity of partners, specifically targeting their people and systems. This service involves offering expert support, advice, recommendations, or strategic guidance to define the path forward on the conceptual and design phase, diagnosing complex challenges and determining the optimal course of action without UNOPS direct execution.",
            ServiceLine = @"Financial Management",
            GrantSupportImplementingModality = true,
            GrantSupportComponent = true,
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Financial management-related services",
            Level2 = @"Technical assistance services - financial management",
            DefinitionLevel2 = @"The provision of specialized operational expertise to guide, review, and support the partner’s implementation efforts. This service provides technical guidance for complex processes without UNOPS taking over direct execution.",
            ServiceLine = @"Financial Management",
            GrantSupportImplementingModality = true,
            GrantSupportComponent = true,
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Financial management-related services",
            Level3 = @"Training services - financial management",
            DefinitionLevel3 = @"A targeted educational intervention designed strictly to enhance the knowledge, skills, and competencies of individual personnel. It is delivered through finite learning events, such as workshops, seminars, or certification courses, aimed at closing immediate skill gaps to empower individuals to perform their roles effectively.",
            ServiceLine = @"Financial Management",
            GrantSupportImplementingModality = true,
            GrantSupportComponent = true,
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Financial management-related services",
            Level3 = @"Capacity building - financial management",
            DefinitionLevel3 = @"A broad, systemic intervention designed to strengthen institutional infrastructure and the enabling environment. It focuses on advising on and developing organizational assets, such as governance structures, operational systems, and frameworks, that are sustained nationally or institutionally.",
            ServiceLine = @"Financial Management",
            GrantSupportImplementingModality = true,
            GrantSupportComponent = true,
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Human resources-related services",
            Level1 = @"HR contract management services",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Human resources-related services",
            Level2 = @"HR contract management services (under competitive selection)",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Human resources-related services",
            Level2 = @"HR contract management services (under preselection)",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Human resources-related services",
            Level2 = @"Contract administration",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Human resources-related services",
            Level2 = @"Benefits and entitlements and payroll",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Human resources-related services",
            Level2 = @"HR GA stakeholder management",
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Human resources-related services",
            Level1 = @"Technical advisory services - HR",
            DefinitionLevel1 = @"The provision of high-level strategic expertise to expand the capacity of partners, specifically targeting their people and systems. This service involves offering expert support, advice, recommendations, or strategic guidance to define the path forward on the conceptual and design phase, diagnosing complex challenges and determining the optimal course of action without UNOPS direct execution.",
            ServiceLine = @"Human Resources",
            GrantSupportImplementingModality = true,
            GrantSupportComponent = true,
        ...
        outputs.Add(new Output
        {
            ...
            Level0 = @"Human resources-related services",
            Level2 = @"Technical assistance services - HR",
            DefinitionLevel2 = @"The provision of specialized operational expertise to guide, review, and support the partner’s implementation efforts. This service provides technical guidance for complex processes without UNOPS taking over direct execution.",
            ServiceLine = @"Human Resources",
            GrantSupportImplementingModality = true,
            GrantSupportComponent = true,
