...
BEGIN
    ...
    -- ================================================================
        ...
        (6, 'WorkflowStage', 'WorkflowStage', 'Current workflow stage', false, true, NULL, NULL, 4, true, 4, 'name', 'workflowStage.name', NULL, 'Workflow Stage', 'text', '15%', false, true, NULL, 'Current stage in the workflow', NULL, NULL, NULL, NULL, 'WorkflowStage', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        ...
        (6, 'IntendedImpactOutcomes', 'string', 'Intended impact and outcomes', false, true, NULL, 4000, 19, false, NULL, NULL, 'intendedImpactOutcomes', NULL, NULL, 'text', NULL, true, false, NULL, 'Expected impact and outcomes of the opportunity', NULL, NULL, NULL, NULL, 'IntendedImpactOutcomes', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (6, 'ExpectedBeneficiaries', 'string', 'Expected beneficiaries', false, true, NULL, 4000, 20, false, NULL, NULL, 'expectedBeneficiaries', NULL, NULL, 'text', NULL, true, false, NULL, 'Who will benefit from this opportunity', NULL, NULL, NULL, NULL, 'ExpectedBeneficiaries', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (6, 'Challenges', 'string', 'Challenges description', false, true, NULL, 4000, 21, false, NULL, NULL, 'challenges', NULL, NULL, 'text', NULL, true, false, NULL, 'Anticipated challenges', NULL, NULL, NULL, NULL, 'Challenges', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        
        -- Boolean Flags
        (6, 'IsPooledFunding', 'boolean', 'Whether funding is pooled across multiple partners', false, true, 'false', NULL, 22, false, NULL, NULL, 'isPooledFunding', NULL, NULL, 'boolean', NULL, false, true, NULL, 'Pooled funding indicator', NULL, NULL, NULL, NULL, 'IsPooledFunding', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        
        -- Enum Fields
        (6, 'DeliveryModality', 'enum', 'How UNOPS will deliver products and services', false, true, NULL, NULL, 23, false, NULL, NULL, 'deliveryModality', NULL, NULL, 'text', NULL, false, true, NULL, 'Delivery modality classification', NULL, NULL, NULL, NULL, 'DeliveryModality', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        
        -- Text Fields
        (6, 'MiscExternalStakeholders', 'string', 'Free-text list of external stakeholders not in contact list', false, true, NULL, 2000, 24, false, NULL, NULL, 'miscExternalStakeholders', NULL, NULL, 'text', NULL, true, false, NULL, 'External stakeholders not in system', NULL, NULL, NULL, NULL, 'MiscExternalStakeholders', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        ...
        (6, 'WorkflowStageId', 'int', 'FK to WorkflowStage', false, true, NULL, NULL, 26, false, NULL, NULL, 'workflowStageId', NULL, NULL, 'text', NULL, false, true, NULL, NULL, NULL, NULL, NULL, NULL, 'WorkflowStageId', 0, 1, NOW(), 0, NULL, false, 0, NULL),
