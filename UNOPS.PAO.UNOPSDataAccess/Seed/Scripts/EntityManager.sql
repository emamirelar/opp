...
BEGIN
    ...
    INSERT INTO public."EntityFieldManagers" (
        ...
        (2, 'PartnerOrgUnit', 'string', 'Partner organization units', false, true, NULL, NULL, 7, true, 7, NULL, 'partnerOrgUnit', NULL, 'Partner Org Unit', 'text', '15%', true, false, NULL, 'Partner organization units', 'PartnerOrgUnit', 0, 1, NOW(), 0, NULL, false, 0, NULL),

        -- Core Partner Fields (Non-List View)
        (2, 'Id', 'int', 'Unique identifier for the partner', true, true, NULL, NULL, 8, false, NULL, NULL, 'id', NULL, NULL, 'text', NULL, false, true, NULL, NULL, 'Id', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (2, 'PartnerLongDescription', 'string', 'Optional long description', false, true, NULL, 4000, 9, false, NULL, NULL, 'partnerLongDescription', NULL, NULL, 'text', NULL, true, true, NULL, NULL, 'PartnerLongDescription', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        
        -- System Generated Keys
        (2, 'UniqueKey', 'guid', 'System-generated unique identifier', true, true, NULL, NULL, 10, false, NULL, NULL, 'uniqueKey', NULL, NULL, 'text', NULL, false, false, NULL, NULL, 'UniqueKey', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (2, 'PartnerKey', 'guid', 'System-generated partner key', true, true, NULL, NULL, 11, false, NULL, NULL, 'partnerKey', NULL, NULL, 'text', NULL, false, false, NULL, NULL, 'PartnerKey', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (2, 'PartnerCategoryInternalKey', 'guid', 'System-generated category internal key', true, true, NULL, NULL, 12, false, NULL, NULL, 'partnerCategoryInternalKey', NULL, NULL, 'text', NULL, false, false, NULL, NULL, 'PartnerCategoryInternalKey', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (2, 'PartnerCategoryKey', 'guid', 'System-generated category key', true, true, NULL, NULL, 13, false, NULL, NULL, 'partnerCategoryKey', NULL, NULL, 'text', NULL, false, false, NULL, NULL, 'PartnerCategoryKey', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (2, 'PartnerTypeKey', 'guid', 'System-generated type key', true, true, NULL, NULL, 14, false, NULL, NULL, 'partnerTypeKey', NULL, NULL, 'text', NULL, false, false, NULL, NULL, 'PartnerTypeKey', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        
        -- Foreign Keys and Relationships
        (2, 'PartnerGroupId', 'int', 'FK to Partner Group', false, true, NULL, NULL, 15, false, NULL, NULL, 'partnerGroupId', NULL, NULL, 'text', NULL, false, true, NULL, NULL, 'PartnerGroupId', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (2, 'PartnerCategoryId', 'int', 'FK to Partner Category', false, true, NULL, NULL, 16, false, NULL, NULL, 'partnerCategoryId', NULL, NULL, 'text', NULL, false, true, NULL, NULL, 'PartnerCategoryId', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (2, 'ErpDimValue', 'int', 'ERP dimension value', false, true, NULL, NULL, 17, false, NULL, NULL, 'erpDimValue', NULL, NULL, 'text', NULL, false, true, NULL, NULL, 'ErpDimValue', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (2, 'LiaisonOfficeId', 'int', 'FK to LiaisonOffice', false, true, NULL, NULL, 18, false, NULL, NULL, 'liaisonOfficeId', NULL, NULL, 'text', NULL, false, true, NULL, NULL, 'LiaisonOfficeId', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (2, 'PartnerFocalPointUserId', 'int', 'Business Developer UserId', false, true, NULL, NULL, 19, false, NULL, NULL, 'partnerFocalPointUserId', NULL, NULL, 'text', NULL, false, true, NULL, NULL, 'PartnerFocalPointUserId', 0, 1, NOW(), 0, NULL, false, 0, NULL),
...
BEGIN
    ...
    INSERT INTO public."EntityFieldManagers" (
        ...
        (3, 'InteractionContactsList', 'string', 'Comma-separated list of interaction contacts', false, true, NULL, NULL, 11, true, 6, NULL, 'interactionContactsList', NULL, 'Contacts', 'text', '15%', true, false, NULL, 'Associated contacts', 'InteractionContactsList', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (3, 'InteractionPartnersList', 'string', 'Comma-separated list of interaction partners', false, true, NULL, NULL, 12, true, 7, NULL, 'interactionPartnersList', NULL, 'Partners', 'text', '15%', true, false, NULL, 'Associated partners', 'InteractionPartnersList', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (3, 'InteractionUsersList', 'string', 'Comma-separated list of interaction users', false, true, NULL, NULL, 13, true, 8, NULL, 'interactionUsersList', NULL, 'Users', 'text', '10%', true, false, NULL, 'Associated users', 'InteractionUsersList', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (3, 'InteractionOrgUnits', 'string', 'Comma-separated list of interaction organization units', false, true, NULL, NULL, 14, true, 9, NULL, 'interactionOrgUnits', NULL, 'Org Units', 'text', '15%', true, false, NULL, 'Associated organization units', 'InteractionOrgUnits', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        
        -- Navigation Properties (Many-to-Many Collections)
        (3, 'InteractionContacts', 'InteractionContact[]', 'Many-to-many relationship with contacts', false, true, NULL, NULL, 15, false, NULL, NULL, 'interactionContacts', NULL, NULL, 'text', NULL, false, false, NULL, NULL, 'InteractionContacts', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (3, 'InteractionPartners', 'InteractionPartner[]', 'Many-to-many relationship with partners', false, true, NULL, NULL, 16, false, NULL, NULL, 'interactionPartners', NULL, NULL, 'text', NULL, false, false, NULL, NULL, 'InteractionPartners', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (3, 'InteractionUsers', 'InteractionUser[]', 'Many-to-many relationship with users', false, true, NULL, NULL, 17, false, NULL, NULL, 'interactionUsers', NULL, NULL, 'text', NULL, false, false, NULL, NULL, 'InteractionUsers', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (3, 'OrganizationUnitRelationships', 'OrganizationUnitRelationship[]', 'Many-to-many relationship with organization units', false, true, NULL, NULL, 18, false, NULL, NULL, 'organizationUnitRelationships', NULL, NULL, 'text', NULL, false, false, NULL, NULL, 'OrganizationUnitRelationships', 0, 1, NOW(), 0, NULL, false, 0, NULL),
        (3, 'Documents', 'Document[]', 'Collection of interaction-related documents', false, true, NULL, NULL, 19, false, NULL, NULL, 'documents', NULL, NULL, 'text', NULL, false, false, NULL, NULL, 'Documents', 0, 1, NOW(), 0, NULL, false, 0, NULL),
