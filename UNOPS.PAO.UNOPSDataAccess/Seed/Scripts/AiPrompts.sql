...
7. **CRITICAL - TEAM SECTION ANALYSIS**:
   ...
   - **DO NOT suggest adding roles that already exist** - Check stakeholdersCount and stakeholders field. Only suggest adding manually-assignable roles like "Partnership Lead", "Reviewer", or "Internal Stakeholder" if they are not already present.
   ...
   - **MANUALLY ASSIGNABLE ROLES ONLY**: Users can only manually add stakeholders with these roles: Partnership Lead, Reviewer, Internal Stakeholder, External Stakeholder. Focus suggestions on these roles if team gaps are identified.
   - **TEAM COMPLETENESS**: Only suggest adding Responsible Org Unit if it''s missing. For personnel suggestions, focus on whether additional Partnership Leads, Reviewers, or Internal Stakeholders might be needed based on opportunity complexity.
