        ...
        public static async Task SeedEntityPermissionsAsync(UNOPSAppDbContext context)
        {
            ...
            var permissions = new List<EntityPermission>
            {
                ...
                { 
                    ...
                    PropertyFilter = "{\"CanRead\": [], \"CanCreate\": [], \"CanUpdate\": [\"Id\", \"Name\", \"PartnerShortDescription\", \"PartnerLongDescription\", \"PartnerCategoryId\", \"PartnerFocalPointUserId\", \"PartnerLevelCode\", \"PartnerLevelShort\", \"PartnerLevelDescription\"], \"CanDelete\": []}",
                    CanRead = true,
                    CanCreate = true,
                    CanUpdate = true,
                    CanDelete = false
                ...
                { 
                    ...
                    Role = "GMAIL_GEN_USER",
                    RowFilter = "{\"CanRead\": \"\", \"CanCreate\": \"\", \"CanUpdate\": \"\", \"CanDelete\": \"\"}",
                    PropertyFilter = "{\"CanRead\": [\"CreatedBy\", \"LastModifiedBy\", \"CreatedAt\", \"LastModifiedDate\", \"IsDeleted\", \"Status\", \"PartnerOffice\", \"PartnerCategoryCode\", \"PartnerGroupCode\", \"Description\", \"Address\", \"Website\", \"Country\", \"Region\", \"PartnerId\"], \"CanCreate\": [], \"CanUpdate\": [], \"CanDelete\": []}",
                    CanRead = true,
                    CanCreate = false,
                    CanUpdate = false,
                    CanDelete = false
                ...
                { 
                    Entity = "Contact", 
                    Role = "PARTNER_USER",
                    RowFilter = "{\"CanRead\": \"\", \"CanCreate\": \"Partner != null && Partner.PartnerOffice != null && Partner.PartnerOffice.Code == @userOrgUnit\", \"CanUpdate\": \"Partner != null && Partner.PartnerOffice != null && Partner.PartnerOffice.Code == @userOrgUnit\", \"CanDelete\": \"Partner != null && Partner.PartnerOffice != null && Partner.PartnerOffice.Code == @userOrgUnit\"}",
                    PropertyFilter = null,
                    CanRead = true,
                    CanCreate = true,
                    CanUpdate = true,
                ...
                { 
                    ...
                    Role = "GMAIL_GEN_USER",
                    RowFilter = "{\"CanRead\": \"\", \"CanCreate\": \"\", \"CanUpdate\": \"\", \"CanDelete\": \"\"}",
                    PropertyFilter = "{\"CanRead\": [\"CreatedBy\", \"LastModifiedBy\", \"CreatedAt\", \"LastModifiedDate\", \"IsDeleted\", \"Status\", \"Partner\", \"PartnerId\", \"Name\", \"Description\", \"Phone\", \"Address\", \"Website\", \"Country\", \"Region\", \"Department\", \"Position\", \"OrganizationName\"], \"CanCreate\": [], \"CanUpdate\": [], \"CanDelete\": []}",
                    CanRead = true,
                    CanCreate = true,
                    CanUpdate = false,
                    CanDelete = false
