...
| POS-031 | Prompt with nested variables | {{parent.child}} | Save | Nested structure accepted | P2 |
| POS-032 | Template with conditional logic | {{#if}}...{{/if}} | Save | Handlebars parsed | P2 |
| POS-033 | View prompt in read-only mode | No edit permission | Open prompt | View only, no edit controls | P2 |
| POS-034 | Prompt with multi-line template | Line breaks | Save | Newlines preserved | P2 |
| POS-035 | Get prompt by ID | Valid ID | API GetById | Prompt returned | P2 |
