...
public class EntityConfigEdgeCaseTests
{
    ...
    public async Task CreateEntityConfig_MinLengthName_AcceptsShort()
    {
        ...
        response.StatusCode.Should().BeOneOf(HttpStatusCode.Created, HttpStatusCode.OK, HttpStatusCode.Forbidden, HttpStatusCode.BadRequest, HttpStatusCode.InternalServerError);
    }
    ...
    public async Task AddField_SingleField_Succeeds()
    {
        ...
        fieldRes.StatusCode.Should().BeOneOf(HttpStatusCode.Created, HttpStatusCode.Forbidden, HttpStatusCode.BadRequest, HttpStatusCode.InternalServerError);
    }
    ...
    public async Task UpdateEntityConfig_ImmediatelyAfterCreation_Succeeds()
    {
        ...
        updateRes.StatusCode.Should().BeOneOf(HttpStatusCode.OK, HttpStatusCode.Forbidden, HttpStatusCode.InternalServerError);
    }
    ...
    public async Task DeleteEntityConfig_ImmediatelyAfterCreation_Succeeds()
    {
        ...
        deleteRes.StatusCode.Should().BeOneOf(HttpStatusCode.NoContent, HttpStatusCode.Forbidden, HttpStatusCode.InternalServerError);
    }
