...
namespace UNOPS.PAO.Tests.Integration.Controllers
{
    ...
    public class PartnerControllerNegativeTests : IClassFixture<PAOWebApplicationFactory<Program>>
    {
        ...
        public async Task ForceDeletePartner_CascadeFailures_ReturnsError()
        {
            ...
            // Assert
            response.StatusCode.Should().BeOneOf(HttpStatusCode.InternalServerError, HttpStatusCode.BadRequest, HttpStatusCode.OK, HttpStatusCode.Unauthorized);
        }
