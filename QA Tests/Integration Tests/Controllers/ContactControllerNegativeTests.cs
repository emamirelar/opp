...
namespace UNOPS.PAO.Tests.Integration.Controllers
{
    ...
    public class ContactControllerNegativeTests
    {
        ...
        public async Task MoveContactToPartner_NonExistentPartnerId_ReturnsBadRequest()
        {
            ...
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.NotFound, HttpStatusCode.Unauthorized, HttpStatusCode.MethodNotAllowed, HttpStatusCode.InternalServerError);
        }
