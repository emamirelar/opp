...
namespace UNOPS.PAO.Tests.Integration.Controllers
{
    ...
    public class InteractionControllerNegativeTests : IClassFixture<PAOWebApplicationFactory<Program>>
    {
        ...
        {
            var response = await _client.GetAsync("/api/interaction/999999");
        ...
        {
            var response = await _client.GetAsync("/api/interaction/0");
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.NotFound);
        }
        ...
        {
            var response = await _client.GetAsync("/api/interaction?partnerId=-999");
        ...
        {
            var response = await _client.GetAsync("/api/interaction?startDate=2025-12-31&endDate=2025-01-01");
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.OK);
        }
        ...
        {
            var response = await _client.GetAsync("/api/interaction?type=INVALID_TYPE_999");
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.OK);
        }
        ...
        {
            var response = await _client.GetAsync("/api/interaction?pageSize=10000");
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.OK);
        }
        ...
        {
            var response = await _client.GetAsync("/api/interaction/888888/attachments");
        ...
        {
            var response = await _client.GetAsync("/api/interaction/777777/timeline");
            response.StatusCode.Should().BeOneOf(HttpStatusCode.NotFound, HttpStatusCode.Unauthorized);
        }
        ...
        {
            var response = await _client.GetAsync("/api/interaction?sortBy=NonExistentField123");
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.OK);
        }
        ...
        {
            var response = await _client.PostAsync("/api/interaction", null);
        ...
        public async Task CreateInteraction_MissingRequiredType_ReturnsBadRequest()
        {
            ...
            var response = await _client.PostAsJsonAsync("/api/interaction", invalidInteraction);
        ...
        public async Task CreateInteraction_FutureDate_ReturnsWarningOrError()
        {
            ...
            var response = await _client.PostAsJsonAsync("/api/interaction", futureInteraction);
        ...
        public async Task CreateInteraction_SqlInjectionInSubject_SafelyHandled()
        {
            ...
            var response = await _client.PostAsJsonAsync("/api/interaction", maliciousInteraction);
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.OK, HttpStatusCode.Unauthorized);
        }
        ...
        {
            var updateData = new { Subject = "Updated Subject" };
            var response = await _client.PutAsJsonAsync("/api/interaction/333333", updateData);
            response.StatusCode.Should().BeOneOf(HttpStatusCode.NotFound, HttpStatusCode.Unauthorized);
        }
        ...
        {
            var updateData = new { Subject = "" };
            var response = await _client.PutAsJsonAsync("/api/interaction/1", updateData);
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.Unauthorized);
        }
        ...
        {
            var updateData = new { Type = "INVALID_TYPE_999" };
            var response = await _client.PutAsJsonAsync("/api/interaction/1", updateData);
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.Unauthorized);
        }
        ...
        {
            var updateData = new { Date = "INVALID_DATE" };
            var response = await _client.PutAsJsonAsync("/api/interaction/1", updateData);
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.Unauthorized);
        }
        ...
        {
            var updateData = new { Subject = "Concurrent Update", RowVersion = "outdated_version" };
            var response = await _client.PutAsJsonAsync("/api/interaction/1", updateData);
        ...
        {
            var updateData = new { ContactIds = new[] { 222222, 111111 } };
            var response = await _client.PutAsJsonAsync("/api/interaction/1", updateData);
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.Unauthorized);
        }
        ...
        public async Task BulkUpdateInteractions_EmptyArray_ReturnsBadRequest()
        {
            ...
            var response = await _client.PutAsJsonAsync("/api/interaction/bulk", emptyArray);
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.OK, HttpStatusCode.Unauthorized);
        }
        ...
        {
            var response = await _client.DeleteAsync("/api/interaction/999999");
            response.StatusCode.Should().BeOneOf(HttpStatusCode.NotFound, HttpStatusCode.Unauthorized);
        }
        ...
        {
            var response = await _client.DeleteAsync("/api/interaction/1");
        ...
        {
            var response = await _client.DeleteAsync("/api/interaction/-999");
        ...
        public async Task BulkDeleteInteractions_EmptyArray_ReturnsBadRequest()
        {
            ...
            var response = await _client.PostAsJsonAsync("/api/interaction/bulk-delete", emptyIds);
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.OK, HttpStatusCode.Unauthorized);
        }
        ...
        {
            var response = await _client.DeleteAsync("/api/interaction/1?force=false");
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.Conflict, HttpStatusCode.OK, HttpStatusCode.Unauthorized);
        }
