 ...
 * @created 2026-01-29
 * @status ✅ 100% Complete (30/30 tests implemented)
 */
...
public class LiaisonOfficeControllerTests : IntegrationTestBase
{
    ...
    public async Task GetAllLiaisonOffices_AuthenticatedUser_ReturnsPaginatedList()
    {
        ...
        var offices = await response.Content.ReadFromJsonAsync<dynamic>();
        offices.Should().NotBeNull("because paginated liaison offices should be returned");
    }
    ...
    public async Task GetLiaisonOfficeById_ExistingOffice_ReturnsOfficeDetails()
    {
        ...
        // Act
        var response = await client.GetAsync($"/api/liaison-offices/{officeId}");
    ...
    public async Task CreateLiaisonOffice_ValidData_ReturnsCreatedOffice()
    {
        ...
        // Act
        var response = await client.PostAsJsonAsync("/api/liaison-offices", newOffice);

        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.Created, "because valid office should be created");
        var createdOffice = await response.Content.ReadFromJsonAsync<dynamic>();
        createdOffice.Should().NotBeNull("because created office should be returned");
    }
    ...
    public async Task CreateLiaisonOffice_DuplicateCode_ReturnsConflict()
    {
        ...
        // Act
        var response = await client.PostAsJsonAsync("/api/liaison-offices", duplicateOffice);

        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.Conflict, "because duplicate code should be rejected");
    }
    ...
    public async Task UpdateLiaisonOffice_ExistingOffice_ReturnsSuccess()
    {
        ...
        // Act
        var response = await client.PutAsJsonAsync($"/api/liaison-offices/{officeId}", updateData);

        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because existing office should be updated");
        var updatedOffice = await response.Content.ReadFromJsonAsync<dynamic>();
        updatedOffice.Should().NotBeNull("because updated office should be returned");
    }
    ...
    public async Task DeleteLiaisonOffice_UnlinkedOffice_ReturnsSuccess()
    {
        ...
        // Act
        var response = await client.DeleteAsync($"/api/liaison-offices/{officeId}");

        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.NoContent, "because unlinked office should be deleted");
    }
    ...
    public async Task DeleteLiaisonOffice_OfficeWithPartners_ReturnsBadRequest()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.BadRequest, "because office with partners cannot be deleted");
    }
    ...
    public async Task GetLiaisonOfficeByCode_ValidCode_ReturnsOffice()
    {
        ...
        // Act
        var response = await client.GetAsync($"/api/liaison-offices/code/{officeCode}");

        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because office with code should be found");
        var office = await response.Content.ReadFromJsonAsync<dynamic>();
        office.Should().NotBeNull("because office matching code should be returned");
    }
    ...
    public async Task AssociatePartnerWithOffice_ValidPartnerAndOffice_ReturnsSuccess()
    {
        ...
        // Act
        var response = await client.PostAsync($"/api/liaison-offices/{officeId}/partners/{partnerId}", null);

        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because partner should be linked to office");
    }
    ...
    public async Task RemovePartnerFromOffice_LinkedPartner_ReturnsSuccess()
    {
        ...
        // Act
        var response = await client.DeleteAsync($"/api/liaison-offices/{officeId}/partners/{partnerId}");

        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because partner should be unlinked from office");
    }
    ...
    public async Task GetPartnersByOffice_OfficeWithPartners_ReturnsPartnerList()
    {
        ...
        // Act
        var response = await client.GetAsync($"/api/liaison-offices/{officeId}/partners");

        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because office partners should be accessible");
        var partners = await response.Content.ReadFromJsonAsync<List<dynamic>>();
        partners.Should().NotBeNull("because all linked partners should be returned");
    }
    ...
    public async Task GetOfficeByPartner_PartnerWithOffice_ReturnsOffice()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because partner's office should be accessible");
        var office = await response.Content.ReadFromJsonAsync<dynamic>();
        office.Should().NotBeNull("because partner's liaison office should be returned");
    }
    ...
    public async Task SearchOfficesByName_PartialName_ReturnsMatchingOffices()
    {
        ...
        // Act
        var response = await client.GetAsync($"/api/liaison-offices?search={searchTerm}");
        ...
        offices.Should().NotBeNull("because matching offices should be returned");
    }
    ...
    public async Task FilterOfficesByCountry_ValidCountryCode_ReturnsFilteredOffices()
    {
        ...
        // Act
        var response = await client.GetAsync($"/api/liaison-offices?country={countryCode}");

        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because country filtering should be supported");
        var offices = await response.Content.ReadFromJsonAsync<List<dynamic>>();
        offices.Should().NotBeNull("because only Kenya offices should be returned");
    }
    ...
    public async Task FilterOfficesByRegion_ValidRegion_ReturnsFilteredOffices()
    {
        ...
        // Act
        var response = await client.GetAsync($"/api/liaison-offices?region={region}");

        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because region filtering should be supported");
        var offices = await response.Content.ReadFromJsonAsync<List<dynamic>>();
        offices.Should().NotBeNull("because only Africa region offices should be returned");
    }
    ...
    public async Task GetOffices_WithPagination_ReturnsPaginatedResults()
    {
        ...
        // Act
        var response = await client.GetAsync($"/api/liaison-offices?page={page}&pageSize={pageSize}");

        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because pagination should be supported");
        var result = await response.Content.ReadFromJsonAsync<dynamic>();
        result.Should().NotBeNull("because correct page with metadata should be returned");
    }
    ...
    public async Task GetOffices_WithSorting_ReturnsSortedOffices()
    {
        ...
        // Act
        var response = await client.GetAsync("/api/liaison-offices?sortBy=name&sortDir=asc");

        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because sorting should be supported");
        var offices = await response.Content.ReadFromJsonAsync<List<dynamic>>();
        offices.Should().NotBeNull("because offices should be sorted correctly");
    }
    ...
    public async Task GetOfficesByOrgUnit_ValidOrgUnit_ReturnsFilteredOffices()
    {
        ...
        // Act
        var response = await client.GetAsync($"/api/liaison-offices?orgUnitId={orgUnitId}");

        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because org unit filtering should be supported");
        var offices = await response.Content.ReadFromJsonAsync<List<dynamic>>();
        offices.Should().NotBeNull("because only org unit offices should be returned");
    }
    ...
    public async Task TypeaheadSearch_PartialQuery_ReturnsSuggestions()
    {
        ...
        // Act
        var response = await client.GetAsync($"/api/liaison-offices/typeahead?q={query}");
        ...
        suggestions.Should().NotBeNull("because offices starting with 'Nai' should be returned");
    }
    ...
    public async Task ExportOffices_WithPermission_ReturnsExportFile()
    {
        ...
        // Act
        var response = await client.GetAsync("/api/liaison-offices/export");

        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because export should succeed");
        response.Content.Headers.ContentType?.MediaType.Should().Contain("csv", "because valid export file should be returned");
    }
    ...
    public async Task GetOffices_WithoutPermission_ReturnsForbidden()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.Forbidden, "because user lacks office permission");
    }
    ...
    public async Task GetOffices_RestrictedUser_ReturnsFilteredOffices()
    {
        ...
        var offices = await response.Content.ReadFromJsonAsync<List<dynamic>>();
        offices.Should().NotBeNull("because results should be filtered by org unit");
    ...
    public async Task UpdateOffice_ReadOnlyUser_ReturnsForbidden()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.Forbidden, "because read-only user cannot update");
    }
    ...
    public async Task CreateOffice_InvalidCodeFormat_ReturnsBadRequest()
    {
        ...
        // Act
        var response = await client.PostAsJsonAsync("/api/liaison-offices", invalidOffice);

        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.BadRequest, "because invalid code format should be rejected");
    }
    ...
    public async Task CreateOffice_MissingRequiredFields_ReturnsBadRequest()
    {
        ...
        // Act
        var response = await client.PostAsJsonAsync("/api/liaison-offices", incompleteOffice);

        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.BadRequest, "because required fields must be provided");
    }
    ...
    public async Task CreateOffice_InvalidEmail_ReturnsBadRequest()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.BadRequest, "because invalid email format should be rejected");
    }
    ...
    public async Task CreateOffice_InvalidPhone_ReturnsBadRequest()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.BadRequest, "because invalid phone format should be rejected");
    }
