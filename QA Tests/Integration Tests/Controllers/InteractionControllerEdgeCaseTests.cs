...
namespace UNOPS.PAO.Tests.Integration.Controllers
{
    ...
    public class InteractionControllerEdgeCaseTests
    {
        ...
        public async Task CreateInteraction_MinLengthSubject_Accepts()
        {
            ...
            response.StatusCode.Should().BeOneOf(HttpStatusCode.Created, HttpStatusCode.OK, HttpStatusCode.Unauthorized, HttpStatusCode.BadRequest, HttpStatusCode.InternalServerError);
        }
        ...
        public async Task CreateThenImmediateUpdate_NoDelay_HandlesGracefully()
        {
            ...
            updateResponse.StatusCode.Should().BeOneOf(HttpStatusCode.OK, HttpStatusCode.BadRequest, HttpStatusCode.NotFound, HttpStatusCode.Unauthorized, HttpStatusCode.NoContent, HttpStatusCode.InternalServerError);
        }
