 ...
 * @created 2026-01-29
 * @status ✅ 100% Complete (32/32 tests implemented)
 */
...
public class DocumentControllerTests : IntegrationTestBase
{
    ...
    public async Task GetAllDocuments_PartnerEntity_ReturnsPartnerDocuments()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because partner documents should be accessible");
        var documents = await response.Content.ReadFromJsonAsync<List<dynamic>>();
        documents.Should().NotBeNull("because partner's documents should be returned");
    }
    ...
    public async Task GetAllDocuments_ContactEntity_ReturnsContactDocuments()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because contact documents should be accessible");
        var documents = await response.Content.ReadFromJsonAsync<List<dynamic>>();
        documents.Should().NotBeNull("because contact's documents should be returned");
    }
    ...
    public async Task GetAllDocuments_InteractionEntity_ReturnsInteractionDocuments()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because interaction documents should be accessible");
        var documents = await response.Content.ReadFromJsonAsync<List<dynamic>>();
        documents.Should().NotBeNull("because interaction's documents should be returned");
    }
    ...
    public async Task GetAllDocuments_InvalidEntityName_ReturnsBadRequest()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.BadRequest, "because invalid entity name should be rejected");
    }
    ...
    public async Task GetAllDocuments_InvalidEntityId_ReturnsEmptyList()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because endpoint should return empty list for non-existent entity");
        var documents = await response.Content.ReadFromJsonAsync<List<dynamic>>();
        documents.Should().NotBeNull().And.BeEmpty("because no documents exist for non-existent entity");
    }
    ...
    public async Task GetAllDocuments_NoDocuments_ReturnsEmptyList()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because empty result is valid");
        var documents = await response.Content.ReadFromJsonAsync<List<dynamic>>();
        documents.Should().NotBeNull().And.BeEmpty("because entity has no documents");
    }
    ...
    public async Task GetAllDocuments_WithDocuments_ReturnsDocumentList()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because documents should be returned");
        var documents = await response.Content.ReadFromJsonAsync<List<dynamic>>();
    ...
    public async Task GetAllDocuments_IncludesMetadata_ReturnsCompleteInfo()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because documents should be accessible");
        var documents = await response.Content.ReadFromJsonAsync<List<dynamic>>();
        documents.Should().NotBeNull("because documents with metadata should be returned");
    ...
    public async Task GetDocumentById_ValidId_ReturnsDocument()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because document should be found");
        var document = await response.Content.ReadFromJsonAsync<dynamic>();
        document.Should().NotBeNull("because document details should be returned");
    }
    ...
    public async Task GetDocumentById_InvalidId_ReturnsNotFound()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.NotFound, "because document does not exist");
    }
    ...
    public async Task GetDocumentById_DeletedDocument_ReturnsNotFound()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.NotFound, "because deleted documents should not be accessible");
    }
    ...
    public async Task GetDocumentById_IncludesCompleteDetails_ReturnsAllFields()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because document should be accessible");
        var document = await response.Content.ReadFromJsonAsync<dynamic>();
        document.Should().NotBeNull("because complete document details should be returned");
    ...
    public async Task GetDocumentById_IncludesDownloadLink_ReturnsLink()
    {
        ...
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because document should be accessible");
        var document = await response.Content.ReadFromJsonAsync<dynamic>();
        document.Should().NotBeNull("because document with download link should be returned");
    ...
    public async Task UpdateDocument_ValidData_ReturnsSuccess()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because valid update should succeed");
    }
    ...
    public async Task UpdateDocument_NoPermission_ReturnsForbidden()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.Forbidden, "because user lacks edit permission");
    }
    ...
    public async Task UpdateDocument_Description_UpdatesDescription()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because description update should succeed");
    }
    ...
    public async Task UpdateDocument_Type_UpdatesType()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because type update should succeed");
    }
    ...
    public async Task UpdateDocument_Tags_UpdatesTags()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because tags update should succeed");
    }
    ...
    public async Task GenerateGoogleDoc_ValidData_ReturnsDocLink()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because Google Doc generation should succeed");
        var result = await response.Content.ReadFromJsonAsync<dynamic>();
        result.Should().NotBeNull("because document link should be returned");
    }
    ...
    public async Task GenerateGoogleDoc_EmptyData_ReturnsBadRequest()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.BadRequest, "because empty data should be rejected");
    }
    ...
    public async Task GenerateGoogleDoc_WithFilename_UsesProvidedFilename()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because custom filename should be accepted");
    }
    ...
    public async Task GenerateGoogleDoc_WithoutFilename_UsesDefaultFilename()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because default filename should be used");
    }
    ...
    public async Task GenerateGoogleDoc_MarkdownContent_ConvertsCorrectly()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because Markdown content should be converted");
    }
    ...
    public async Task GenerateGoogleDoc_LargeContent_HandlesCorrectly()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.OK, "because large content should be handled");
    }
    ...
    public async Task UpdateDocument_PartnerDocument_RequiresPartnerEditPermission()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.Forbidden, "because partner edit permission is required");
    }
    ...
    public async Task UpdateDocument_ContactDocument_RequiresContactEditPermission()
    {
        ...
        // Assert
        response.StatusCode.Should().Be(HttpStatusCode.Forbidden, "because contact edit permission is required");
    }
