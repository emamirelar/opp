...
namespace UNOPS.PAO.Tests.Integration.Controllers
{
    ...
    public class ContactControllerEdgeCaseTests : IClassFixture<PAOWebApplicationFactory<Program>>
    {
        ...
        {
            var chineseContact = new { FirstName = "李", LastName = "明", Email = "li@example.com" };
        ...
        {
            var arabicContact = new { FirstName = "محمد", LastName = "علي", Email = "arabic@example.com" };
        ...
        {
            var emojiContact = new { FirstName = "John 😊", LastName = "Doe", Email = "emoji@example.com" };
        ...
        {
            var cyrillicContact = new { FirstName = "Иван", LastName = "Петров", Email = "ivan@example.com" };
        ...
        {
            var mixedContact = new { FirstName = "John李", LastName = "Doeمحمد", Email = "mixed@example.com" };
        ...
        {
            var response = await _client.GetAsync("/api/contact?search=李");
            response.StatusCode.Should().BeOneOf(HttpStatusCode.OK, HttpStatusCode.Unauthorized);
        }
        ...
        {
            var accentedContact = new { FirstName = "José", LastName = "García", Email = "jose@example.com" };
        ...
        public async Task SetContactAsPrimary_Concurrent_OnlyOneSucceeds()
        {
            ...
            var responses = await Task.WhenAll(task1, task2);
            responses.Should().Contain(r => r.StatusCode == HttpStatusCode.OK || r.StatusCode == HttpStatusCode.Conflict || r.StatusCode == HttpStatusCode.Unauthorized);
        }
