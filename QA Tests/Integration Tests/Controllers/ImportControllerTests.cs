...
namespace UNOPS.PAO.Tests.Integration.Controllers
{
    ...
    public class ImportControllerTests : IClassFixture<PAOWebApplicationFactory<Program>>
    {
        ...
        public async Task ImportData_ExcessiveFileSize_ReturnsError()
        {
            ...
            var response = await _client.PostAsync("/api/import/Partners", content);
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.RequestEntityTooLarge, HttpStatusCode.Unauthorized);
        }
        ...
        public async Task ImportData_DuplicateRecords_HandlesOrRejects()
        {
            ...
            var response = await _client.PostAsync("/api/import/Partners", content);
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.OK, HttpStatusCode.Conflict, HttpStatusCode.Unauthorized);
        }
        ...
        public async Task ImportData_PartialSuccess_ReturnsStatusReport()
        {
            ...
            var response = await _client.PostAsync("/api/import/Partners", content);
            response.StatusCode.Should().BeOneOf(HttpStatusCode.OK, HttpStatusCode.BadRequest, HttpStatusCode.MultiStatus, HttpStatusCode.Unauthorized);
        }
        ...
        public async Task ImportData_TimeoutScenario_GracefulDegradation()
        {
            ...
            try { await _client.PostAsync("/api/import/Partners", content); }
        ...
        public async Task ImportData_AsyncProcessing_ReturnsAccepted()
        {
            ...
            response.StatusCode.Should().BeOneOf(HttpStatusCode.Accepted, HttpStatusCode.OK, HttpStatusCode.Unauthorized);
        }
        ...
        public async Task ImportData_VirusScan_MaliciousFilesBlocked()
        {
            ...
            var response = await _client.PostAsync("/api/import/Partners", content);
            response.StatusCode.Should().BeOneOf(HttpStatusCode.OK, HttpStatusCode.BadRequest, HttpStatusCode.Forbidden, HttpStatusCode.Unauthorized);
        }
        ...
        public async Task ImportData_ResourceExhaustion_LimitsEnforced()
        {
            ...
            content.Add(new ByteArrayContent(csvData), "file", "huge.csv");
            var response = await _client.PostAsync("/api/import/Partners", content);
            response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.OK, HttpStatusCode.RequestEntityTooLarge, HttpStatusCode.Unauthorized);
        }
        ...
        public async Task ImportData_HorizontalPrivilegeEscalation_Blocked()
        {
            ...
            content.Add(new ByteArrayContent(csvData), "file", "test.csv");
            var response = await _client.PostAsync("/api/import/Partners", content);
            response.StatusCode.Should().BeOneOf(HttpStatusCode.Forbidden, HttpStatusCode.BadRequest, HttpStatusCode.OK, HttpStatusCode.Unauthorized);
        }
