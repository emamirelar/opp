...
namespace UNOPS.PAO.Tests.Integration.Controllers
{
    ...
    public class ValuesControllerEdgeCaseTests : IClassFixture<PAOWebApplicationFactory<Program>>
    {
        ...
        public async Task GetValuesByType_ETags_SupportsConditionalRequests()
        {
            ...
            if (response1.Headers.ETag != null)
            {
                ...
                response2.StatusCode.Should().BeOneOf(HttpStatusCode.OK, HttpStatusCode.NotModified);
            }
        }
        ...
        public async Task GetValuesByType_RangeRequest_HandlesPartialContent()
        {
            ...
            var response = await _client.SendAsync(request);
            response.StatusCode.Should().BeOneOf(HttpStatusCode.OK, HttpStatusCode.PartialContent, HttpStatusCode.RequestedRangeNotSatisfiable);
        }
