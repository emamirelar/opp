...
public class PerformanceTests : PNO1197TestFixtureBase
{
    ...
    [Fact]
    public async Task PERF_001_DoACheckWith1EntityUserRole_LessThan50ms()
    {
    ...
    [Fact]
    public async Task PERF_002_DoACheckWith10EntityUserRoles_LessThan100ms()
    {
        await SeedOpportunityAsync(1, "IDENTIFY & PROFILE");
        for (var i = 0; i < 9; i++)
