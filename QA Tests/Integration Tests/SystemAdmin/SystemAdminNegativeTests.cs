...
public class SystemAdminNegativeTests : IClassFixture<PAOWebApplicationFactory<Program>>
{
    ...
    public async Task RunSpecificSeeder_InvalidChars_Returns404Or400()
    {
        ...
        response.StatusCode.Should().BeOneOf(HttpStatusCode.OK, HttpStatusCode.NotFound, HttpStatusCode.BadRequest, HttpStatusCode.Forbidden, HttpStatusCode.Unauthorized);
    }
