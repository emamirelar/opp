...
public class AnalyticsValidationTests : IClassFixture<PAOWebApplicationFactory<Program>>
{
    ...
    public async Task GetMostActive_AllValidTimeframesAccepted()
    {
        ...
        foreach (var timeframe in timeframes)
        {
            ...
            response.StatusCode.Should().Be(HttpStatusCode.OK, $"timeframe={timeframe} should be accepted");
        }
    }
    ...
    public async Task GetMostActive_AllValidMetricsAccepted()
    {
        ...
        foreach (var metric in metrics)
        {
            ...
            response.StatusCode.Should().Be(HttpStatusCode.OK, $"metric={metric} should be accepted");
        }
    }
