...
public class PartnerTreeNegativeTests
{
    ...
    public async Task GetPartnerTreeById_NonExistent_Returns404()
    {
        ...
        response.StatusCode.Should().BeOneOf(HttpStatusCode.NotFound, HttpStatusCode.BadRequest, HttpStatusCode.Unauthorized, HttpStatusCode.Forbidden, HttpStatusCode.InternalServerError);
    }
    ...
    public async Task PostPartnerTree_EmptyBody_Returns400()
    {
        ...
        response.StatusCode.Should().BeOneOf(HttpStatusCode.BadRequest, HttpStatusCode.Unauthorized, HttpStatusCode.Forbidden, HttpStatusCode.InternalServerError);
    }
    ...
    public async Task PutPartnerTree_EmptyArray_Returns400Or200()
    {
        ...
        response.StatusCode.Should().BeOneOf(HttpStatusCode.OK, HttpStatusCode.BadRequest, HttpStatusCode.Unauthorized, HttpStatusCode.Forbidden, HttpStatusCode.InternalServerError);
    }
