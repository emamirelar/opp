# WorkflowManager — Test Cases

**Component:** `UNOPS.PAO.Business/Managers/WorkflowManager`  
...
**WorkflowManager** manages stage transitions, status management, history, permissions, notifications, and approval chains. Key responsibilities: workflow path, workflow state, workflow log, stage transitions, next actions.
