...
**OrganizationHierarchyManager** manages CRUD org units, hierarchy traversal, type enforcement, and permission scope. Key responsibilities: org hierarchy tree, get by type (OrgUnit/Hub/Region), parent-child relationships, Prime format mapping.
