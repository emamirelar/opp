...
**UserDataManager** manages CRUD user data, preferences, saved searches, recent items, and favorites. Key responsibilities: user-specific data, preferences storage, saved search/filter persistence, recent items, favorites.
