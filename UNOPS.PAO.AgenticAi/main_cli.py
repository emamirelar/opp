#!/usr/bin/env python3
"""
CLI version of Opportunity+ AI Agent
...
from opportunity_ai_agent.agent import root_agent
...
db_url = os.getenv('DATABASE_URL', 'postgresql://postgres:0Y%2FX3YNxHLL0fL4T@localhost:5433/anusha')
...
async def main_async():
    ...
    print("\nWelcome to Opportunity+ AI Assistant!")
