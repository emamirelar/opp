...
using UNOPS.PAO.UNOPSDataAccess.Context;  // Use UNOPSAppDbContext instead
...
public static class PartnerExtensions
{
    ...
    /// </summary>
    public static async Task LoadOrganizationUnitRelationshipsAsync(this Partner partner, UNOPSAppDbContext context)
    {
        if (partner?.Id > 0)
        {
    ...
    /// </summary>
    public static async Task LoadOrganizationUnitRelationshipsAsync(this IEnumerable<Partner> partners, UNOPSAppDbContext context)
    {
    ...
    /// </summary>
    public static async Task EnsureOrganizationUnitRelationshipsLoadedAsync(this IEnumerable<Partner> partners, UNOPSAppDbContext context)
    {
