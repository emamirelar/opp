...
def get_identity_toolkit_api_key() -> str:
    ...
    try:
        ...
        return config_manager.get_identity_toolkit_api_key()
    except ImportError:
        print("⚠️ Warning: Could not import config_manager, using empty API key")
        return ""

def exchange_google_id_token_for_gcip_id_token(google_open_id_connect_token: str) -> str:
  url = SIGN_IN_WITH_IDP_API + '?key=' + get_identity_toolkit_api_key()
